...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MOR"}');
	...
	gocar:
        ...
        echo "\n".color("green","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("white","🔐▶️ SEKARANG ANU LAGI");
        echo "\n".color("yellow","⏳▶️ NGANU PEKOK");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(20);
        }
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD040520A"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🔓▶️ Message: ".$message);
	...
	$post = [
         ...
         echo color("green","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PINNYA = 168168 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"168168"}';
